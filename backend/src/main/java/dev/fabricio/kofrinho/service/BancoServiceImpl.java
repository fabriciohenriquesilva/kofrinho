...
import dev.fabricio.kofrinho.repository.querybuilder.BancoQueryBuilder;
...
public class BancoServiceImpl extends AbstractCrudService<Banco, Integer, BancoCreateRequestDTO, BancoUpdateRequestDTO> implements BancoService {
    ...
    public List<Banco> list(BancoFilterDTO filterDTO) {
        // TODO mapear para um objeto page com os resultados

        

        return new BancoQueryBuilder(getEntityManager())
                .list(filterDTO);
    }
}
